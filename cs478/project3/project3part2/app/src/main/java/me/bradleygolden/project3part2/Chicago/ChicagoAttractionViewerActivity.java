...
import me.bradleygolden.project3part2.Chicago.ChicagoListFragment.ListSelectionListener;
import me.bradleygolden.project3part2.Indianpolis.IndyAttractionViewerActivity;
import me.bradleygolden.project3part2.R;

public class ChicagoAttractionViewerActivity extends AppCompatActivity implements ListSelectionListener {

    public static String[] mChicagoAttractionArray = null;
    public static String[] mChicagoAttractionURLArray = null;

    private FrameLayout mListFrameLayout, mWebViewFrameLayout;
    private ChicagoWebViewFragment mWebViewFragment = new ChicagoWebViewFragment();;
    private ChicagoListFragment mListFragment;
...
//            disableListView();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get List of Chicago Attractions
        mChicagoAttractionArray = getResources().getStringArray(R.array.chicago_attractions);
        mChicagoAttractionURLArray = getResources().getStringArray(R.array.chicago_attraction_urls);
    ...
    private void setUp(){
        ...
        mListFragment = new ChicagoListFragment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.chicago:
                Toast.makeText(getApplicationContext(), "You're already browsing Chicago", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.indy:
