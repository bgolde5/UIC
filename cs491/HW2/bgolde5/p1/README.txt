...
1. I’ve used both the edit distance and jaccard similarity method to determine which classes are similar to other classes. In this process, I’ve restricted the difference coefficient to 5 characters for edit distance and the jaccard similarity coefficient to 0.6. This proved to be the best balance between overcorrecting classes and under correcting classes. Of course there may be a few miscorrections.
