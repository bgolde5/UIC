...
main(int argc, char *argv[])
{
  ...
  47:	e8 56 03 00 00       	call   3a2 <mkdir>
  ...
  66:	c7 44 24 04 b5 08 00 	movl   $0x8b5,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46b:	0f b6 80 3c 0b 00 00 	movzbl 0xb3c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5c8:	75 09                	jne    5d3 <printf+0x101>
          s = "(null)";
 5ca:	c7 45 f4 d1 08 00 00 	movl   $0x8d1,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 694:	a1 58 0b 00 00       	mov    0xb58,%eax
...
free(void *ap)
{
 ...
 75f:	a3 58 0b 00 00       	mov    %eax,0xb58
}
 764:	c9                   	leave  
 765:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7b2:	e8 ce fe ff ff       	call   685 <free>
  return freep;
 7b7:	a1 58 0b 00 00       	mov    0xb58,%eax
}
 7bc:	c9                   	leave  
 7bd:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7d0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7d3:	a1 58 0b 00 00       	mov    0xb58,%eax
 7d8:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7db:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7df:	75 23                	jne    804 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7e1:	c7 45 f0 50 0b 00 00 	movl   $0xb50,-0x10(%ebp)
 7e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7eb:	a3 58 0b 00 00       	mov    %eax,0xb58
 7f0:	a1 58 0b 00 00       	mov    0xb58,%eax
 7f5:	a3 50 0b 00 00       	mov    %eax,0xb50
    base.s.size = 0;
 7fa:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 801:	00 00 00 
  }
 ...
 857:	a3 58 0b 00 00       	mov    %eax,0xb58
      return (void*)(p + 1);
 ...
 862:	eb 38                	jmp    89c <malloc+0xde>
    ...
    if(p == freep)
 864:	a1 58 0b 00 00       	mov    0xb58,%eax
