...
main(int argc, char *argv[])
{
  ...
  1f:	b8 7b 08 00 00       	mov    $0x87b,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 7d 08 00 00       	mov    $0x87d,%eax
  ...
  45:	c7 44 24 04 7f 08 00 	movl   $0x87f,0x4(%esp)
  4c:	00 
  4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  54:	e8 56 04 00 00       	call   4af <printf>
int
main(int argc, char *argv[])
{
  int i;
  ...
  65:	7c ac                	jl     13 <main+0x13>
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
  exit();
  67:	e8 ab 02 00 00       	call   317 <exit>
...
printf(int fd, char *fmt, ...)
{
 ...
 5a5:	75 09                	jne    5b0 <printf+0x101>
          s = "(null)";
 5a7:	c7 45 f4 84 08 00 00 	movl   $0x884,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 73c:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 741:	c9                   	leave  
 742:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ad:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7b0:	a1 0c 0b 00 00       	mov    0xb0c,%eax
 7b5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7b8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7bc:	75 23                	jne    7e1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7be:	c7 45 f0 04 0b 00 00 	movl   $0xb04,-0x10(%ebp)
 7c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c8:	a3 0c 0b 00 00       	mov    %eax,0xb0c
 7cd:	a1 0c 0b 00 00       	mov    0xb0c,%eax
 7d2:	a3 04 0b 00 00       	mov    %eax,0xb04
    base.s.size = 0;
 7d7:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 7de:	00 00 00 
  }
 ...
 834:	a3 0c 0b 00 00       	mov    %eax,0xb0c
      return (void*)(p + 1);
 ...
 83f:	eb 38                	jmp    879 <malloc+0xde>
    ...
    if(p == freep)
 841:	a1 0c 0b 00 00       	mov    0xb0c,%eax
