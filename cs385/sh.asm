...
runcmd(struct cmd *cmd)
{
  ...
  if(cmd == 0)
    ...
    exit();
       c:	e8 93 0f 00 00       	call   fa4 <exit>
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 34 15 00 00 	mov    0x1534(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 08 15 00 00 	movl   $0x1508,(%esp)
  ...
  case EXEC:
    ...
    if(ecmd->argv[0] == 0)
      ...
      exit();
      40:	e8 5f 0f 00 00       	call   fa4 <exit>
    exec(ecmd->argv[0], ecmd->argv);
      ...
      58:	e8 7f 0f 00 00       	call   fdc <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
      60:	8b 40 04             	mov    0x4(%eax),%eax
      63:	89 44 24 08          	mov    %eax,0x8(%esp)
      67:	c7 44 24 04 0f 15 00 	movl   $0x150f,0x4(%esp)
      6e:	00 
      6f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      76:	e8 c1 10 00 00       	call   113c <printf>
    break;
  ...
  case REDIR:
    ...
    close(rcmd->fd);
      ...
      8f:	e8 38 0f 00 00       	call   fcc <close>
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      a7:	e8 38 0f 00 00       	call   fe4 <open>
      ...
      ba:	c7 44 24 04 1f 15 00 	movl   $0x151f,0x4(%esp)
      c1:	00 
      c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      c9:	e8 6e 10 00 00       	call   113c <printf>
      exit();
      ce:	e8 d1 0e 00 00       	call   fa4 <exit>
    }
    runcmd(rcmd->cmd);
  ...
  case LIST:
    ...
    wait();
     103:	e8 a4 0e 00 00       	call   fac <wait>
    runcmd(lcmd->right);
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     127:	e8 88 0e 00 00       	call   fb4 <pipe>
     12c:	85 c0                	test   %eax,%eax
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 2f 15 00 00 	movl   $0x152f,(%esp)
    ...
    if(fork1() == 0){
     ...
     14c:	e8 7b 0e 00 00       	call   fcc <close>
      dup(p[1]);
     151:	8b 45 e0             	mov    -0x20(%ebp),%eax
     154:	89 04 24             	mov    %eax,(%esp)
     157:	e8 c0 0e 00 00       	call   101c <dup>
      close(p[0]);
     15c:	8b 45 dc             	mov    -0x24(%ebp),%eax
     15f:	89 04 24             	mov    %eax,(%esp)
     162:	e8 65 0e 00 00       	call   fcc <close>
      close(p[1]);
     167:	8b 45 e0             	mov    -0x20(%ebp),%eax
     16a:	89 04 24             	mov    %eax,(%esp)
     16d:	e8 5a 0e 00 00       	call   fcc <close>
      runcmd(pcmd->left);
    ...
    if(fork1() == 0){
     ...
     190:	e8 37 0e 00 00       	call   fcc <close>
      dup(p[0]);
     195:	8b 45 dc             	mov    -0x24(%ebp),%eax
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 7c 0e 00 00       	call   101c <dup>
      close(p[0]);
     1a0:	8b 45 dc             	mov    -0x24(%ebp),%eax
     1a3:	89 04 24             	mov    %eax,(%esp)
     1a6:	e8 21 0e 00 00       	call   fcc <close>
      close(p[1]);
     1ab:	8b 45 e0             	mov    -0x20(%ebp),%eax
     1ae:	89 04 24             	mov    %eax,(%esp)
     1b1:	e8 16 0e 00 00       	call   fcc <close>
      runcmd(pcmd->right);
    ...
    close(p[0]);
     ...
     1ca:	e8 fd 0d 00 00       	call   fcc <close>
    close(p[1]);
     1cf:	8b 45 e0             	mov    -0x20(%ebp),%eax
     1d2:	89 04 24             	mov    %eax,(%esp)
     1d5:	e8 f2 0d 00 00       	call   fcc <close>
    wait();
     1da:	e8 cd 0d 00 00       	call   fac <wait>
    wait();
     1df:	e8 c8 0d 00 00       	call   fac <wait>
    break;
  ...
  exit();
     206:	e8 99 0d 00 00       	call   fa4 <exit>
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 4c 15 00 	movl   $0x154c,0x4(%esp)
     218:	00 
     219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     220:	e8 17 0f 00 00       	call   113c <printf>
  memset(buf, 0, nbuf);
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    if(fd >= 3){
     ...
     282:	e8 45 0d 00 00       	call   fcc <close>
      break;
     287:	eb 1f                	jmp    2a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     290:	00 
     291:	c7 04 24 4f 15 00 00 	movl   $0x154f,(%esp)
     298:	e8 47 0d 00 00       	call   fe4 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     33d:	00 
     33e:	c7 04 24 c0 1a 00 00 	movl   $0x1ac0,(%esp)
  ...
  exit();
     352:	e8 4d 0c 00 00       	call   fa4 <exit>
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     364:	c7 44 24 04 65 15 00 	movl   $0x1565,0x4(%esp)
     36b:	00 
     36c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     373:	e8 c4 0d 00 00       	call   113c <printf>
  exit();
     378:	e8 27 0c 00 00       	call   fa4 <exit>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3af:	e8 74 10 00 00       	call   1428 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ed:	e8 36 10 00 00       	call   1428 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     458:	e8 cb 0f 00 00       	call   1428 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4a8:	e8 7b 0f 00 00       	call   1428 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4f8:	e8 2b 0f 00 00       	call   1428 <malloc>
     ...
     542:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55b:	c7 04 24 a0 1a 00 00 	movl   $0x1aa0,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     605:	c7 04 24 a0 1a 00 00 	movl   $0x1aa0,(%esp)
     ...
     622:	c7 04 24 a6 1a 00 00 	movl   $0x1aa6,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 a0 1a 00 00 	movl   $0x1aa0,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 a0 1a 00 00 	movl   $0x1aa0,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 6e 15 00 	movl   $0x156e,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 6f 15 00 	movl   $0x156f,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 de 09 00 00       	call   113c <printf>
    panic("syntax");
     75e:	c7 04 24 7e 15 00 00 	movl   $0x157e,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 85 15 00 	movl   $0x1585,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 87 15 00 	movl   $0x1587,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 89 15 00 	movl   $0x1589,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 8b 15 00 00 	movl   $0x158b,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 a8 15 00 	movl   $0x15a8,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 ab 15 00 	movl   $0x15ab,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 ad 15 00 00 	movl   $0x15ad,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 b8 15 00 	movl   $0x15b8,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 ba 15 00 00 	movl   $0x15ba,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 ab 15 00 	movl   $0x15ab,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b75:	74 0c                	je     b83 <parseexec+0xb1>
      panic("syntax");
     b77:	c7 04 24 7e 15 00 00 	movl   $0x157e,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba8:	7e 0c                	jle    bb6 <parseexec+0xe4>
      panic("too many args");
     baa:	c7 04 24 cd 15 00 00 	movl   $0x15cd,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd2:	c7 44 24 08 db 15 00 	movl   $0x15db,0x8(%esp)
     bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3c:	8b 04 85 e0 15 00 00 	mov    0x15e0(,%eax,4),%eax
     c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     e30:	e8 87 01 00 00       	call   fbc <read>
...
stat(char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     e95:	e8 4a 01 00 00       	call   fe4 <open>
...
0000104c <thread_exit>:
SYSCALL(thread_exit)
    104c:	b8 17 00 00 00       	mov    $0x17,%eax
    1051:	cd 40                	int    $0x40
    1053:	c3                   	ret    

00001054 <thread_join>:
SYSCALL(thread_join)
    1054:	b8 18 00 00 00       	mov    $0x18,%eax
    1059:	cd 40                	int    $0x40
    105b:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    105f:	83 ec 18             	sub    $0x18,%esp
    1062:	8b 45 0c             	mov    0xc(%ebp),%eax
    1065:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    1068:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    106f:	00 
    1070:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1073:	89 44 24 04          	mov    %eax,0x4(%esp)
    1077:	8b 45 08             	mov    0x8(%ebp),%eax
    107a:	89 04 24             	mov    %eax,(%esp)
    107d:	e8 42 ff ff ff       	call   fc4 <write>
}
    1082:	c9                   	leave  
    1083:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    1093:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    1097:	74 17                	je     10b0 <printint+0x2c>
    1099:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    109d:	79 11                	jns    10b0 <printint+0x2c>
    neg = 1;
    109f:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    10a6:	8b 45 0c             	mov    0xc(%ebp),%eax
    10a9:	f7 d8                	neg    %eax
    10ab:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10ae:	eb 06                	jmp    10b6 <printint+0x32>
  } else {
    x = xx;
  ...
  i = 0;
    10b6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    10bd:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    10c0:	8d 41 01             	lea    0x1(%ecx),%eax
    10c3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    10c6:	8b 5d 10             	mov    0x10(%ebp),%ebx
    10c9:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10cc:	ba 00 00 00 00       	mov    $0x0,%edx
    10d1:	f7 f3                	div    %ebx
    10d3:	89 d0                	mov    %edx,%eax
    10d5:	0f b6 80 ae 1a 00 00 	movzbl 0x1aae(%eax),%eax
    10dc:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    10e0:	8b 75 10             	mov    0x10(%ebp),%esi
    10e3:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10e6:	ba 00 00 00 00       	mov    $0x0,%edx
    10eb:	f7 f6                	div    %esi
    10ed:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10f0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    10f4:	75 c7                	jne    10bd <printint+0x39>
  if(neg)
    10f6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    10fa:	74 10                	je     110c <printint+0x88>
    buf[i++] = '-';
    10fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    10ff:	8d 50 01             	lea    0x1(%eax),%edx
    1102:	89 55 f4             	mov    %edx,-0xc(%ebp)
    1105:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    110a:	eb 1f                	jmp    112b <printint+0xa7>
    110c:	eb 1d                	jmp    112b <printint+0xa7>
    putc(fd, buf[i]);
    110e:	8d 55 dc             	lea    -0x24(%ebp),%edx
    1111:	8b 45 f4             	mov    -0xc(%ebp),%eax
    ...
    1126:	e8 31 ff ff ff       	call   105c <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    112b:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    112f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1133:	79 d9                	jns    110e <printint+0x8a>
    putc(fd, buf[i]);
}
    1135:	83 c4 30             	add    $0x30,%esp
    1138:	5b                   	pop    %ebx
    1139:	5e                   	pop    %esi
    113a:	5d                   	pop    %ebp
    113b:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    113f:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    1142:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    1149:	8d 45 0c             	lea    0xc(%ebp),%eax
    114c:	83 c0 04             	add    $0x4,%eax
    114f:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    1152:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1159:	e9 7c 01 00 00       	jmp    12da <printf+0x19e>
    c = fmt[i] & 0xff;
    115e:	8b 55 0c             	mov    0xc(%ebp),%edx
    1161:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1164:	01 d0                	add    %edx,%eax
    1166:	0f b6 00             	movzbl (%eax),%eax
    1169:	0f be c0             	movsbl %al,%eax
    116c:	25 ff 00 00 00       	and    $0xff,%eax
    1171:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    1174:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1178:	75 2c                	jne    11a6 <printf+0x6a>
      if(c == '%'){
    117a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    117e:	75 0c                	jne    118c <printf+0x50>
        state = '%';
    1180:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1187:	e9 4a 01 00 00       	jmp    12d6 <printf+0x19a>
      } else {
        putc(fd, c);
    ...
    119c:	e8 bb fe ff ff       	call   105c <putc>
    11a1:	e9 30 01 00 00       	jmp    12d6 <printf+0x19a>
      }
    } else if(state == '%'){
    11a6:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    11aa:	0f 85 26 01 00 00    	jne    12d6 <printf+0x19a>
      if(c == 'd'){
    11b0:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    11b4:	75 2d                	jne    11e3 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    11b6:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11b9:	8b 00                	mov    (%eax),%eax
    11bb:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    11c2:	00 
    11c3:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    11ca:	00 
    11cb:	89 44 24 04          	mov    %eax,0x4(%esp)
    11cf:	8b 45 08             	mov    0x8(%ebp),%eax
    11d2:	89 04 24             	mov    %eax,(%esp)
    11d5:	e8 aa fe ff ff       	call   1084 <printint>
        ap++;
    11da:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11de:	e9 ec 00 00 00       	jmp    12cf <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    11e3:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    11e7:	74 06                	je     11ef <printf+0xb3>
    11e9:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    11ed:	75 2d                	jne    121c <printf+0xe0>
        printint(fd, *ap, 16, 0);
    11ef:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11f2:	8b 00                	mov    (%eax),%eax
    11f4:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    11fb:	00 
    11fc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    1203:	00 
    1204:	89 44 24 04          	mov    %eax,0x4(%esp)
    1208:	8b 45 08             	mov    0x8(%ebp),%eax
    120b:	89 04 24             	mov    %eax,(%esp)
    120e:	e8 71 fe ff ff       	call   1084 <printint>
        ap++;
    1213:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1217:	e9 b3 00 00 00       	jmp    12cf <printf+0x193>
      } else if(c == 's'){
    121c:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    1220:	75 45                	jne    1267 <printf+0x12b>
        s = (char*)*ap;
    ...
    1232:	75 09                	jne    123d <printf+0x101>
          s = "(null)";
    1234:	c7 45 f4 f8 15 00 00 	movl   $0x15f8,-0xc(%ebp)
        while(*s != 0){
    123b:	eb 1e                	jmp    125b <printf+0x11f>
    123d:	eb 1c                	jmp    125b <printf+0x11f>
          putc(fd, *s);
    ...
    1252:	e8 05 fe ff ff       	call   105c <putc>
          s++;
    1257:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    1263:	75 da                	jne    123f <printf+0x103>
    1265:	eb 68                	jmp    12cf <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1267:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    126b:	75 1d                	jne    128a <printf+0x14e>
        putc(fd, *ap);
    ...
    127f:	e8 d8 fd ff ff       	call   105c <putc>
        ap++;
    1284:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1288:	eb 45                	jmp    12cf <printf+0x193>
      } else if(c == '%'){
    128a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    128e:	75 17                	jne    12a7 <printf+0x16b>
        putc(fd, c);
    1290:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1293:	0f be c0             	movsbl %al,%eax
    1296:	89 44 24 04          	mov    %eax,0x4(%esp)
    129a:	8b 45 08             	mov    0x8(%ebp),%eax
    129d:	89 04 24             	mov    %eax,(%esp)
    12a0:	e8 b7 fd ff ff       	call   105c <putc>
    12a5:	eb 28                	jmp    12cf <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    12a7:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    12ae:	00 
    12af:	8b 45 08             	mov    0x8(%ebp),%eax
    12b2:	89 04 24             	mov    %eax,(%esp)
    12b5:	e8 a2 fd ff ff       	call   105c <putc>
        putc(fd, c);
    ...
    12ca:	e8 8d fd ff ff       	call   105c <putc>
      }
      state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    12e7:	0f 85 71 fe ff ff    	jne    115e <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    12f2:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    12f5:	8b 45 08             	mov    0x8(%ebp),%eax
    12f8:	83 e8 08             	sub    $0x8,%eax
    12fb:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12fe:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    1303:	89 45 fc             	mov    %eax,-0x4(%ebp)
    1306:	eb 24                	jmp    132c <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1308:	8b 45 fc             	mov    -0x4(%ebp),%eax
    130b:	8b 00                	mov    (%eax),%eax
    130d:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1310:	77 12                	ja     1324 <free+0x35>
    1312:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1315:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1318:	77 24                	ja     133e <free+0x4f>
    131a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    131d:	8b 00                	mov    (%eax),%eax
    131f:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    1322:	77 1a                	ja     133e <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    132f:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1332:	76 d4                	jbe    1308 <free+0x19>
    1334:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1337:	8b 00                	mov    (%eax),%eax
    1339:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    133c:	76 ca                	jbe    1308 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    133e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1341:	8b 40 04             	mov    0x4(%eax),%eax
    1344:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    134b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    134e:	01 c2                	add    %eax,%edx
    1350:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1353:	8b 00                	mov    (%eax),%eax
    1355:	39 c2                	cmp    %eax,%edx
    1357:	75 24                	jne    137d <free+0x8e>
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    13d6:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    13dd:	77 07                	ja     13e6 <morecore+0x16>
    nu = 4096;
    13df:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    13e6:	8b 45 08             	mov    0x8(%ebp),%eax
    13e9:	c1 e0 03             	shl    $0x3,%eax
    13ec:	89 04 24             	mov    %eax,(%esp)
    13ef:	e8 38 fc ff ff       	call   102c <sbrk>
    13f4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    13f7:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    13fb:	75 07                	jne    1404 <morecore+0x34>
    return 0;
    13fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1402:	eb 22                	jmp    1426 <morecore+0x56>
  hp = (Header*)p;
    1404:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1407:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    140a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    140d:	8b 55 08             	mov    0x8(%ebp),%edx
    1410:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    1413:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1416:	83 c0 08             	add    $0x8,%eax
    1419:	89 04 24             	mov    %eax,(%esp)
    141c:	e8 ce fe ff ff       	call   12ef <free>
  return freep;
    1421:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
}
    1426:	c9                   	leave  
    1427:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1431:	83 c0 07             	add    $0x7,%eax
    1434:	c1 e8 03             	shr    $0x3,%eax
    1437:	83 c0 01             	add    $0x1,%eax
    143a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    143d:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    1442:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1445:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1449:	75 23                	jne    146e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    144b:	c7 45 f0 24 1b 00 00 	movl   $0x1b24,-0x10(%ebp)
    1452:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1455:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
    145a:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    145f:	a3 24 1b 00 00       	mov    %eax,0x1b24
    base.s.size = 0;
    1464:	c7 05 28 1b 00 00 00 	movl   $0x0,0x1b28
    146b:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    147c:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    147f:	72 4d                	jb     14ce <malloc+0xa6>
      if(p->s.size == nunits)
    1481:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1484:	8b 40 04             	mov    0x4(%eax),%eax
    1487:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    148a:	75 0c                	jne    1498 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    148c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    148f:	8b 10                	mov    (%eax),%edx
    1491:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1494:	89 10                	mov    %edx,(%eax)
    1496:	eb 26                	jmp    14be <malloc+0x96>
      else {
        p->s.size -= nunits;
    1498:	8b 45 f4             	mov    -0xc(%ebp),%eax
    149b:	8b 40 04             	mov    0x4(%eax),%eax
    149e:	2b 45 ec             	sub    -0x14(%ebp),%eax
    ...
    14af:	c1 e0 03             	shl    $0x3,%eax
    14b2:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    14b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14b8:	8b 55 ec             	mov    -0x14(%ebp),%edx
    14bb:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    14be:	8b 45 f0             	mov    -0x10(%ebp),%eax
    14c1:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
      return (void*)(p + 1);
    14c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14c9:	83 c0 08             	add    $0x8,%eax
    14cc:	eb 38                	jmp    1506 <malloc+0xde>
    }
    if(p == freep)
    14ce:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    14d3:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    14d6:	75 1b                	jne    14f3 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    14d8:	8b 45 ec             	mov    -0x14(%ebp),%eax
    14db:	89 04 24             	mov    %eax,(%esp)
    14de:	e8 ed fe ff ff       	call   13d0 <morecore>
    14e3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    14e6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    14ea:	75 07                	jne    14f3 <malloc+0xcb>
        return 0;
    14ec:	b8 00 00 00 00       	mov    $0x0,%eax
    14f1:	eb 13                	jmp    1506 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1501:	e9 70 ff ff ff       	jmp    1476 <malloc+0x4e>
}
    1506:	c9                   	leave  
    1507:	c3                   	ret    
