...
wc(int fd, char *name)
{
  ...
  54:	c7 04 24 e8 09 00 00 	movl   $0x9e8,(%esp)
  ...
  91:	00 
  92:	c7 44 24 04 e0 0c 00 	movl   $0xce0,0x4(%esp)
  99:	00 
  9a:	8b 45 08             	mov    0x8(%ebp),%eax
  9d:	89 04 24             	mov    %eax,(%esp)
  a0:	e8 f7 03 00 00       	call   49c <read>
  ...
  b8:	c7 44 24 04 ee 09 00 	movl   $0x9ee,0x4(%esp)
  bf:	00 
  c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c7:	e8 50 05 00 00       	call   61c <printf>
    exit();
  cc:	e8 b3 03 00 00       	call   484 <exit>
  }
  printf(1, "%d %d %d %s\n", l, w, c, name);
  ...
  ed:	c7 44 24 04 fe 09 00 	movl   $0x9fe,0x4(%esp)
  f4:	00 
  f5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fc:	e8 1b 05 00 00       	call   61c <printf>
}
 101:	c9                   	leave  
 102:	c3                   	ret    
...
main(int argc, char *argv[])
{
 ...
 110:	7f 19                	jg     12b <main+0x28>
    wc(0, "");
 112:	c7 44 24 04 0b 0a 00 	movl   $0xa0b,0x4(%esp)
 119:	00 
 11a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 121:	e8 da fe ff ff       	call   0 <wc>
    exit();
 126:	e8 59 03 00 00       	call   484 <exit>
  }
 ...
 155:	e8 6a 03 00 00       	call   4c4 <open>
 ...
 17b:	c7 44 24 04 0c 0a 00 	movl   $0xa0c,0x4(%esp)
 182:	00 
 183:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 18a:	e8 8d 04 00 00       	call   61c <printf>
      exit();
 18f:	e8 f0 02 00 00       	call   484 <exit>
    }
    wc(fd, argv[i]);
 ...
 1bd:	e8 ea 02 00 00       	call   4ac <close>
  if(argc <= 1){
    wc(0, "");
    exit();
  }
 ...
 1ce:	0f 8c 64 ff ff ff    	jl     138 <main+0x35>
  ...
  exit();
 1d4:	e8 ab 02 00 00       	call   484 <exit>
...
gets(char *buf, int max)
{
 ...
 310:	e8 87 01 00 00       	call   49c <read>
...
stat(char *n, struct stat *st)
{
 ...
 375:	e8 4a 01 00 00       	call   4c4 <open>
...
SYSCALL(thread_join)
 534:	b8 18 00 00 00       	mov    $0x18,%eax
 539:	cd 40                	int    $0x40
 53b:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 55d:	e8 42 ff ff ff       	call   4a4 <write>
}
 562:	c9                   	leave  
 563:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5b5:	0f b6 80 ac 0c 00 00 	movzbl 0xcac(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 712:	75 09                	jne    71d <printf+0x101>
          s = "(null)";
 714:	c7 45 f4 20 0a 00 00 	movl   $0xa20,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7de:	a1 c8 0c 00 00       	mov    0xcc8,%eax
...
free(void *ap)
{
 ...
 8a9:	a3 c8 0c 00 00       	mov    %eax,0xcc8
}
 8ae:	c9                   	leave  
 8af:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8cf:	e8 38 fc ff ff       	call   50c <sbrk>
 ...
 8fc:	e8 ce fe ff ff       	call   7cf <free>
  return freep;
 901:	a1 c8 0c 00 00       	mov    0xcc8,%eax
}
 906:	c9                   	leave  
 907:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 91a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 91d:	a1 c8 0c 00 00       	mov    0xcc8,%eax
 922:	89 45 f0             	mov    %eax,-0x10(%ebp)
 925:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 929:	75 23                	jne    94e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 92b:	c7 45 f0 c0 0c 00 00 	movl   $0xcc0,-0x10(%ebp)
 932:	8b 45 f0             	mov    -0x10(%ebp),%eax
 935:	a3 c8 0c 00 00       	mov    %eax,0xcc8
 93a:	a1 c8 0c 00 00       	mov    0xcc8,%eax
 93f:	a3 c0 0c 00 00       	mov    %eax,0xcc0
    base.s.size = 0;
 944:	c7 05 c4 0c 00 00 00 	movl   $0x0,0xcc4
 94b:	00 00 00 
  }
 ...
 9a1:	a3 c8 0c 00 00       	mov    %eax,0xcc8
      return (void*)(p + 1);
 ...
 9ac:	eb 38                	jmp    9e6 <malloc+0xde>
    ...
    if(p == freep)
 9ae:	a1 c8 0c 00 00       	mov    0xcc8,%eax
