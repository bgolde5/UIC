...
int domSet = 0; //used in the unstable randomCombinations algorithm to find the smallest sets
...
int main(int argc, char** argv){
  ...
  //choose unstable algorithm for files with greater than 50 verticies
    ...
    printf("This is a large dataset, how long do you want to run this algorithm for?\n");
    printf("Enter time in seconds >> ");
    scanf("%i", &runTime);
    while(time_spent < runTime){
      for(i=N; i>0; i--){
